...
if [ ${stage} -le 10 ] && [ ${stop_stage} -ge 10 ]; then
    ...
    asr_exp=exp_libri100/clean_asr_train_raw_bpe
    ...
    python3 -m espnet2.bin.launch \
        ...
        python3 -m espnet2.bin.asr_train \
            ...
            --cleaner "${cleaner}" \
            --g2p "${g2p}" \
            --train_data_path_and_name_and_type dump_libri100/raw/train/spk1.scp,speech,sound        \
            --train_data_path_and_name_and_type dump_libri100/raw/train/text_spk1,text,text        \
            --valid_data_path_and_name_and_type dump_libri100/raw/dev/spk1.scp,speech,sound          \
            --valid_data_path_and_name_and_type dump_libri100/raw/dev/text_spk1,text,text          \
            --train_shape_file exp_libri100/joint_stats_train_dpsl_asr_raw_16k/train/speech_ref1_shape   \
            --train_shape_file exp_libri100/joint_stats_train_dpsl_asr_raw_16k/train/text_ref1_shape.bpe    \
            --valid_shape_file exp_libri100/joint_stats_train_dpsl_asr_raw_16k/valid/speech_ref1_shape   \
        ...
        for dset in ${test_sets}; do
            ...
            ${_cmd} JOB=1:"${_nj}" "${_logdir}"/asr_inference.JOB.log \
             python3 -m espnet2.bin.asr_inference \
                    ...
                    --asr_model_file "${asr_exp}"/"${decode_joint_model}" \
